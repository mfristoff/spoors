  ...
  return (
    <div className="bg-neutral-bg">
      ...
      <section className="bg-neutral-bg px-5 pt-14 pb-0 text-center md:px-0 md:pt-16">
        ...
        <h1 className="mx-auto mt-5 max-w-[340px] font-heading text-[38px] font-bold leading-[1.02] tracking-[-0.022em] text-ink-950 md:mt-6 md:max-w-none md:text-[clamp(32px,4vw,52px)] md:leading-[1.15] md:tracking-[-0.01em]">
          Get a Fair Estimate From Auburn&rsquo;s{" "}
          <span className="md:block">Trusted HVAC Experts.</span>
        </h1>
        <p className="mx-auto mt-5 max-w-[640px] text-[14px] font-medium leading-[1.6] text-ink-600/80 md:mt-6 md:text-[15px]">
      ...
      <section className="py-16">
        <div className="site-shell max-w-5xl">
          <h2 className="text-center font-heading text-[28px] font-bold text-ink-950 md:text-[36px]">
            Get in Touch with <span className="text-red-600">Spoor's</span>
          </h2>

          {/* Map embed */}
          <div className="mt-8 overflow-hidden rounded-2xl border border-border-light" style={{ height: 380 }}>
            <iframe
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
            ...
            <div key={label} className="rounded-xl border border-border-light bg-neutral-bg p-4">
