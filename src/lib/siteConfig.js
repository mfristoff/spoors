...
export const services = [
  ...
  },
  {
    ...
    short: "Water heater repair, replacement, and routine maintenance for both traditional tank and tankless systems.",
    seoTitle: "Water Heater Repair & Installation in Auburn, CA | Spoor's Heating & Air",
    metaDescription: "Water heater repair, replacement, and tankless installation in Auburn, CA from Spoor's Heating & Air — reliable hot water service for Placer County homes since 1925.",
    ...
    subServices: [
      ...
      { title: "Water Heater Installation", description: "Clean, code-compliant installation of traditional tank and tankless units." },
      { title: "Tankless Water Heaters", description: "Endless hot water and lower energy use with a right-sized tankless system." },
      { title: "Maintenance & Flush", description: "Tank flushing and anode checks that extend equipment life." },
    ...
    overview:
      "Spoor's repairs and replaces traditional and tankless water heaters so your home has reliable hot water. We help you choose efficient equipment and keep it running safely.",
    signs: [
    ...
    benefits: [
      ...
      "Efficient options, including tankless",
    ...
    faqs: [
      ...
      { q: "Should I switch to a tankless water heater?", a: "Tankless systems offer endless hot water and can lower energy use, but they're not right for every home. We'll help you compare tankless versus a traditional tank based on your household's usage." },
      { q: "How long does a water heater last?", a: "Traditional tank water heaters often last 8–12 years, depending on water quality and maintenance. Tankless units typically last longer. If yours is aging and leaking, replacement may be the safer call." },
      { q: "Can Spoor's install a new water heater?", a: "Yes. We install traditional tank and tankless water heaters to code, sized to your household. We'll explain your options and handle the installation cleanly and safely." },
      { q: "Does a water heater need maintenance?", a: "Yes. Flushing the tank to clear sediment and checking the anode rod extend equipment life. Regular care also keeps the unit efficient and reduces noise." },
