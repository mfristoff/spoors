    ...
    <section className="bg-background py-16 lg:py-24">
      <div className="site-shell grid items-center gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:gap-24">
        <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="relative">
          <img src={page.storyImage} alt={`Spoor's team supporting ${page.title.toLowerCase()}`} loading="eager" decoding="async" className="h-[420px] w-full rounded-2xl object-cover object-center lg:h-[620px]" />
        </motion.div>
